...
Frame.Size = UDim2.new(0, 454, 0, 238)
...
TextLabel.Position = UDim2.new(-0.00184842886, 0, 0, 0)
TextLabel.Size = UDim2.new(0, 456, 0, 37)
...
FlingButton.Position = UDim2.new(0.320840836, 0, 0.65440774, 0)
...
TextLabel_2.Position = UDim2.new(0.00170185918, 0, 0.266159743, 0)
TextLabel_2.Size = UDim2.new(0, 477, 0, 37)
...
TextButton.Position = UDim2.new(0.921734929, 0, 0, 0)
...
AntiFlingButton.BackgroundColor3 = Color3.fromRGB(47, 47, 47)
AntiFlingButton.BorderSizePixel = 0
AntiFlingButton.Position = UDim2.new(-0.00267895916, 0, 0.877339602, 0)
AntiFlingButton.Size = UDim2.new(0, 196, 0, 29)
AntiFlingButton.Font = Enum.Font.Gotham
AntiFlingButton.Text = "Anti Fling [Disable Fling]"
...
local function antiFling() -- AntiFlingButton.LocalScript 
	...
	function gayz()
		print("AF Enabled - Disabled Fling")
		script.Parent.Parent.TextBox.Visible = false
		script.Parent.Parent.FlingButton.Visible = false
		script.Parent.Parent.TextLabel.Text = "You can't fling anymore [Anti-Fling Enabled]"
	-- // Constants \\ --
	-- [ Services ] --
